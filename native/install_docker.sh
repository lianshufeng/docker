...
installHelper(){
	...
	curl -SL https://proxy.jpy.wang/github.com/docker/compose/releases/download/v2.24.7/docker-compose-linux-$(uname -m) -o $DOCKER_CONFIG/cli-plugins/docker-compose
